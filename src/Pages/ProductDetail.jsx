...
function ProductDetail() {
  ...
  return (
    <>
      <div className="container mx-auto px-4 md:px-8 bg-gray-900 min-h-screen rounded-2xl my-8 p-6 md:p-12 border border-gray-800 text-white">
        <Link to={"/"}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="w-full flex justify-center">
            <img
              src={product.image}
              alt={product.name}
              className="w-100 h-100 object-cover rounded-2xl shadow-2xl shadow-gray-950/50 border border-gray-800"
            />
          </div>

          <div className="flex flex-col justify-between">
            <h1 className="text-4xl font-extrabold text-white leading-tight tracking-tighter mb-4">
              {product.name}
            </h1>
            <p className="text-orange-400 font-extrabold text-3xl mb-4">
            ...
            <div className="mt-5 space-y-4 flex justify-center items-center flex-col">
              <button
                ...
                className=" w-full py-3 bg-orange-600 text-white font-bold rounded-full shadow-lg shadow-orange-800/50 cursor-pointer hover:bg-orange-700 transition duration-300 flex items-center justify-center space-x-2 transform hover:ring-4 hover:ring-orange-600/50 uppercase tracking-wider "
              >
